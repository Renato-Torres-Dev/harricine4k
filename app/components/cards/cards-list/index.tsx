...
export const CardList = () => {
  return (
    <section className="w-full bg-black items-center justify-center">
      <div className="flex flex-col gap-6 lg:gap-12 lg:flex-row px-8 justify-evenly items-center">
        <Image 
          width={200}
          height={285}
      ...
      <div className="flex flex-col gap-6 lg:gap-12 lg:flex-row pt-8 px-8 justify-evenly items-center">
        <Image 
          width={200}
          height={285}
